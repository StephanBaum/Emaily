...
export const DEFAULT_AGENTS: DefaultAgent[] = [
  {
    ...
    color: "#16a34a",
    description:
      "Your main email assistant. Drafts, replies, and refines emails with precision, tone awareness, and emotional intelligence.",
...
- Never write emails longer than necessary – respect the reader's time`,
  },
  {
    ...
    color: "#2563eb",
    description:
      "Crafts persuasive outreach, handles objections, and accelerates deals with strategic, empathetic sales communication.",
    tagLink: "Sales",
...
- Never pressure with fake urgency or scarcity`,
  },
  {
    ...
    color: "#7c3aed",
    description:
      "Resolves customer issues efficiently with empathy. Acknowledges frustrations, owns problems, and aims for one-touch resolution.",
    tagLink: "Support",
...
- Never close without a clear next step`,
  },
  {
    ...
    color: "#d97706",
    description:
      "Translates complex technical details into clear, structured communication. Status updates, bug reports, and proposals.",
...
- Never send technical details without proofreading for accuracy`,
  },
  {
    ...
    color: "#475569",
    description:
      "Crafts concise, authoritative emails for C-suite and leadership. Bottom-line-up-front style with strategic framing.",
...
export const DEFAULT_TAGS = [
  { name: "Urgent", color: "#ef4444", aiAction: "notify" as const, tagGroup: null, description: "Time-sensitive matters requiring immediate attention" },
  { name: "Support", color: "#3b82f6", aiAction: "draft" as const, tagGroup: "Clients", description: "Customer support requests and issues" },
  { name: "Sales", color: "#22c55e", aiAction: "none" as const, tagGroup: "Clients", description: "Sales inquiries, proposals, and deal-related communication" },
  { name: "Newsletter", color: "#8b5cf6", aiAction: "archive" as const, tagGroup: null, description: "Mass emails, newsletters, and marketing broadcasts" },
];
