...
echo ""
echo "=========================================="
echo "Step 3: Generate Client State Secret"
echo "=========================================="
echo ""
echo "Generating random clientState for webhook authentication..."
CLIENT_STATE=$(openssl rand -hex 32)
echo ""
echo "Add this to your .env file:"
echo "OUTLOOK_CLIENT_STATE=\"$CLIENT_STATE\""
echo ""
echo "This secret is used to verify webhook requests are from Microsoft Graph."
echo ""
